...
const FeatureProduct = () => {
  return (
    <div className="w-full bg-white-green pt-5 px-1 lg:px-16 py-16 mb-12">
      <div className="flex flex-col lg:flex-row gap-10 font-base-mono">
        <div className="w-full lg:w-1/2 px-5">
          <Image src={ProductImage} alt="product" className="w-full" />
        </div>
        <div className="w-full lg:w-1/2 p-5 text-dark-gray">
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-start justify-between mt-3">
